...
def run_stabilization_test(show: bool = False):
    """
...
def main(show: bool = False) -> None:
    ...
    times, positions, angle1s, angle2s, forces, plant = run_stabilization_test(show=show)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Double inverted pendulum demo")
