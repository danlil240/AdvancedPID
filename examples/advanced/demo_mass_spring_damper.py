...
def demo_open_loop():
    ...
    colors = {'Underdamped (zeta=0.3)': 'blue', 'Critically Damped (zeta=1.0)': 'green', 'Overdamped (zeta=2.0)': 'red'}
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Mass-spring-damper PID control demo")
