...
def main(show: bool = False) -> None:
    ...
    if not show:
        print("\nAnimated demos require --show flag. Skipping.")
        return
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Animated PID demos")
    parser.add_argument("--show", action="store_true", help="Show interactive animations")
