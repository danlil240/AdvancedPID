...
def main(show: bool = False) -> None:
    ...
    print("\nStarting Demo 1: Basic Identification...")
    demo_basic_identification(csv_path)
    
    print("\nStarting Demo 2: Compare Tuning Rules...")
    demo_compare_tuning_rules(csv_path)
    
    print("\nStarting Demo 3: Complete Autotuning...")
    ...
    print("\nRunning Demo 4: Compare Optimization Methods...")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="System identification and autotuning demo")
